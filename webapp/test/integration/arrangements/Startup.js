sap.ui.define([
	"sap/ui/test/Opa5",
	"pro/det/app/productapp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("pro.det.app.productapp.test.integration.arrangements.Startup", {

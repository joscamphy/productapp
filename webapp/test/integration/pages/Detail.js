						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("PRODUCT_ID");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.PRODUCT_ID === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<To_OrdersPlural> (" + iNumberOfItems + ")"}),
								success : function () {
